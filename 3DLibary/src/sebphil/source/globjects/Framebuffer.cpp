...
namespace glib {
	...
	void Framebuffer::copyTo(std::int32_t width, std::int32_t height, std::uint32_t other) {
		glBlitNamedFramebuffer(glHandle, other, 0, 0, width, height, 0, 0, width, height, GL_COLOR_BUFFER_BIT, GL_NEAREST);
		glBlitNamedFramebuffer(glHandle, other, 0, 0, width, height, 0, 0, width, height, GL_DEPTH_BUFFER_BIT, GL_NEAREST);
		glBlitNamedFramebuffer(glHandle, other, 0, 0, width, height, 0, 0, width, height, GL_STENCIL_BUFFER_BIT, GL_NEAREST);
	}
